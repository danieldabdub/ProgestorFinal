...
public class ClientData{
	...
	public static int insertClient(Connection connection, ClientData client){
        String sql="INSERT INTO Clients VALUES (?, ?, ?, ?, ?, ? )";
        System.out.println("insertClients: " + sql);
        ...
        try {
			...
			stmtInsert.setString(1,client.clientId);
			stmtInsert.setString(2,client.companyName);
			stmtInsert.setString(3,client.countryHq);
			stmtInsert.setString(4, client.contact);
			stmtInsert.setString(5,client.phone);
			stmtInsert.setString(6,client.mail);
            ...
            System.out.println("Error in insertClient: " + sql + " Exception: " + e);
        } 
        return n;
